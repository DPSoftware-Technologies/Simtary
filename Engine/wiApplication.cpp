...
namespace wi
{
	...
	void Application::Compose(CommandList cmd)
	{
		...
		if (infoDisplay.watermark)
		{
			...
			infodisplay_str += "- ARM ";
#elif defined(_WIN64)
			infodisplay_str += "- Win64 ";
#elif defined(_WIN32)
			infodisplay_str += "- Win32 ";
#endif // _ARM
			infodisplay_str += "- ";
...
#endif // _DEBUG
			infowatermark_str = infodisplay_str; // this is used in the color grading helper texture, so it is cached separately
